...
## khroma `r utils::packageVersion("khroma")` (`r Sys.Date()`)
...
### New functions
* Add specific functions for Paul Tol's colour schemes: `scale_*_bright()`, `scale_*_vibrant()`, `scale_*_muted()`, `scale_*_light()`, `scale_*_rainbow()`, `scale_*_sunset()`, `scale_*_BuRd()`, `scale_*_PRGn()`, `scale_*_YlOrBr()`, `scale_*_smoothrainbow()`.
