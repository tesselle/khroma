...
This outlines how to propose a change to khroma. For more detailed info about contributing to this, and other tesselle packages, please see the [**development contributing guide**](https://www.tesselle.org/contributing.html).
...
* Fork the package and clone onto your computer. If you haven't done this before, we recommend using `usethis::create_from_github("tesselle/khroma", fork = TRUE)`.
