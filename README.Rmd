...
scales::show_col(khroma::colour("rainbow")(14),
                 cex_label = 0.7)
scales::show_col(khroma::colour("rainbow")(23),
                 cex_label = 0.7)
```

#### Diverging data

```{r tol-diverging, echo = FALSE}
# Diverging data
par(mfrow = c(1, 3))
